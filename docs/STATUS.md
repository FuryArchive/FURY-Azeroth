...
- M2 T17 Profession Orders: IN_PROGRESS on `agent/m2-professions`; successful craft events now carry verified skill+item recipe identity, replay-safe household order runtime is implemented, and a dedicated DB gate is present.
