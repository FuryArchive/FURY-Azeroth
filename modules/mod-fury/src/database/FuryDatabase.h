...
enum DatabaseStatements : uint32
{
    ...
    FURY_RECALC_HOUSEHOLD_POWER_BAND,
    ...
    FURY_SEL_DIRECTOR_PARTICIPATION,
    FURY_SEL_DIRECTOR_PARTICIPATION_TOTAL,
    FURY_INS_DIRECTOR_PARTICIPATION,
    FURY_RECALC_DIRECTOR_PARTICIPATION,
