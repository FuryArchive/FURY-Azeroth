...
enum DatabaseStatements : uint32
{
    ...
    FURY_SEL_CONTRACT_BOARD_DEFINITIONS,
    ...
    FURY_UPD_DIRECTOR_RUNTIME_RECOVER,
    FURY_UPD_DIRECTOR_RESOLVE,
    FURY_UPD_DIRECTOR_TERMINAL_EVENT,
    ...
    FURY_SEL_BESTIARY_EVENT_MAPPINGS,
